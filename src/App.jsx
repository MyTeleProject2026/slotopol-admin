...
const navItems = [
  ...
  { path: '/control-plane', label: 'Control Plane', icon: '🎛️' }, { path: '/operations', label: 'Operations', icon: '🛡️' },
