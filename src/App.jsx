...
const navItems = [
  ...
  { path: '/currency-transfer', label: 'Currency Transfer', icon: '🔄' }, { path: '/operations', label: 'Operations', icon: '🛡️' },
