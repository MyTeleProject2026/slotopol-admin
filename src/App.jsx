...
const navItems = [
  ...
  { path: '/settlement', label: 'Settlement', icon: '🧾' }, { path: '/access-control', label: 'Access Control', icon: '🔐' },
  { path: '/currency-overview', label: 'Currency Overview', icon: '💱' }, { path: '/currency-ledger', label: 'Currency Ledger', icon: '📒' },
  { path: '/operations', label: 'Operations', icon: '🛡️' }, { path: '/clubs', label: 'Clubs', icon: '🏛️' },
  { path: '/users', label: 'Users', icon: '🧑‍💻' }, { path: '/games', label: 'Game Control', icon: '🎮' },
  { path: '/game-capabilities', label: 'Capabilities', icon: '🧩' }, { path: '/allocations', label: 'Treasury', icon: '💰' },
