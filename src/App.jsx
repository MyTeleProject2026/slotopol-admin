...
const navItems = [
  ...
  { path: '/currency-overview', label: 'Currency Overview', icon: '💱' }, { path: '/operations', label: 'Operations', icon: '🛡️' },
